...
#Violin plot
bwplot <- ggplot(data = complete_old, mapping = aes(x = plot_type, y = hindfoot_length)) + geom_jitter(aes(color = plot_type), alpha = 0.2) + geom_violin(fill = "white")  

# Customizing a boxplot to add faceting by sex
